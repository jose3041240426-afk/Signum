...
export function WordOverlay({ word, confidence, visible }: WordOverlayProps) {
  ...
  return (
    <div
      className="absolute right-5 top-5 rounded-2xl border border-orange-300/30 bg-gray-900/90 p-5 text-white backdrop-blur-md"
    ...
    >
      ...
      <div 
        className="bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-3xl font-black text-transparent drop-shadow-lg"
        style={{ whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}
        title={word || "—"}
      >
        {word || "—"}
      </div>
      <div className="mt-2 text-center" style={{ visibility: word ? "visible" : "hidden" }}>
